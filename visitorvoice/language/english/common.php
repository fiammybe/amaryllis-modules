...
define("_CO_VISITORVOICE_VISITORVOICE_VISITORVOICE_TITLE_DSC", "");
...
define("_CO_VISITORVOICE_VISITORVOICE_VISITORVOICE_PID_DSC", "The ID of the parent to allow moderating");
define("_CO_VISITORVOICE_VISITORVOICE_VISITORVOICE_PUBLISHED_DATE", "Publisched on");
define("_CO_VISITORVOICE_VISITORVOICE_VISITORVOICE_APPROVE", "Approved?");
define("_CO_VISITORVOICE_VISITORVOICE_VISITORVOICE_IMAGE", "Attach Image");

// language constants for editing indexpage
define("_CO_VISITORVOICE_INDEXPAGE_INDEX_HEADER", "Title");
define("_CO_VISITORVOICE_INDEXPAGE_INDEX_HEADER_DSC", " Set Title displayed in the index at frontend ");
define("_CO_VISITORVOICE_INDEXPAGE_INDEX_HEADING", "Description for Indexpage");
define("_CO_VISITORVOICE_INDEXPAGE_INDEX_HEADING_DSC", "  ");
define("_CO_VISITORVOICE_INDEXPAGE_INDEX_IMAGE", "Indeximage");
define("_CO_VISITORVOICE_INDEXPAGE_INDEX_IMAGE_DSC", " Set indeximage ");
define("_CO_VISITORVOICE_INDEXPAGE_INDEX_FOOTER", "footer on indexpage");
define("_CO_VISITORVOICE_INDEXPAGE_INDEX_FOOTER_DSC", " Set the footer displayed on Indexpage ");

...
if (!defined("ICMS_ROOT_PATH")) die("ImpressCMS Basispfad wurde nicht definiert");
 
// general informations
define("_MI_CAREER_NAME", "Career");
define("_MI_CAREER_DSC", "'Career' ist ein Jobsbörse-Stellenanzeigen-Management-Modul für ImpressCMS");
// templates
define("_MI_CAREER_INDEX_TPL", "Stellenanzeigen Index Ansicht");
define("_MI_CAREER_CAREER_TPL", "Stellenanzeigen Einzel Ansicht");
define("_MI_CAREER_MESSAGE_TPL", "Nachrichten Index- und Einzel Ansicht");

...
function b_career_departments_show($options) {
	...
	$block['career_messages'] = $career_message_handler->getCareers(FALSE, $options[1], $options[2], $options[3], 0, $options[0]);
	return $block;
}
...
function b_career_departments_edit($options) {
	...
	$sort = array('weight' => _CO_CAREER_MESSAGE_MESSAGE_WEIGHT, 'career_title' => _CO_CAREER_MESSAGE_MESSAGE_MESSAGE_TITLE, 'career_title' => _CO_CAREER_MESSAGE_MESSAGE_MESSAGE_DATE);

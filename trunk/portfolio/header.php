...
$form = new icms_form_Theme("", "addcontact", "submit.php", "post");
$form->setExtra('name="addcontact"');
...
$form->addElement(new icms_form_elements_Text(_CO_PORTFOLIO_CONTACT_CONTACT_PHONE, "contact_phone", 70, 255, ""));
$form->addElement(new icms_form_elements_Textarea(_CO_PORTFOLIO_CONTACT_CONTACT_BODY, "contact_body"),TRUE);

...
$basedir = basename(__FILE__, '.php');
if(!is_file("mainfile.php")) die("Access Denied");
include_once 'mainfile.php';
$icmsModule = $xoopsModule = icms::handler('icms_module')->getByDirname($basedir, TRUE);
$icmsModuleConfig = $icmsModule->config;
include_once ICMS_MODULES_PATH.'/'.$basedir.'/include/common.php';

$xoopsOption['template_main'] = "db:album_index.html";

include_once 'header.php';

icms_loadLanguageFile("album", "main");

$GLOBALS["MODULE_".strtoupper(ALBUM_DIRNAME)."_USE_MAIN"] = TRUE;
...
include_once ICMS_MODULES_PATH."/".$basedir."/footer.php";
 ...
 * added in 1.3
 */
define("_MI_ALBUM_CONFIG_USE_MAIN", "Use main page only, without having '/modules/".ALBUM_DIRNAME."/' in URL?");
define("_MI_ALBUM_CONFIG_USE_MAIN_DSC", "The module has a seperated frontend for visitors (not submitting new articles!). You can redirect directly to this page.");
define("_MI_ALBUM_CONFIG_USE_REWRITE", "use nice URL's?");
define("_MI_ALBUM_CONFIG_USE_REWRITE_DSC", "Check manual first!!");
...
class mod_artikel_Article extends icms_ipf_seo_Object {
	...
	public function __construct(&$handler) {
		...
		$this->quickInitVar("article_related", XOBJ_DTYPE_OTHER, FALSE);
		$this->quickInitVar("article_tips", XOBJ_DTYPE_TXTAREA, FALSE);
		$this->quickInitVar("article_footer", XOBJ_DTYPE_TXTAREA, FALSE);
		...
		$this->quickInitVar("article_attechment", XOBJ_DTYPE_FILE, FALSE);
		...
		$this->quickInitVar("article_license", XOBJ_DTYPE_TXTBOX, FALSE);

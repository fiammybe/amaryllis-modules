...
$icmsTpl->assign("event_adminpage", "<a href='" . ICMS_URL . "/modules/" . $icmsModule->getVar("dirname") . "/admin/index.php'>" ._MD_EVENT_ADMIN_PAGE . "</a>");
...
$icmsTpl->assign('module_home', '<a href="' . EVENT_URL . '" title="' . $icmsModule->getVar('name') . '">' . $icmsModule->getVar('name') . '</a>');
...
$icmsTpl->assign("display_weeknumber", ($eventConfig['display_weeknumber'] == 1) ? 'true' : 'false');
